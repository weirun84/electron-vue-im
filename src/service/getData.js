...
// import * as usersay from './src/data/userword'
// import * as fcricle from './src/data/friendcircle'
// import * as collectData from './src/data/collect'
// import * as bursetData from './src/data/burse'
// import * as albumData from './src/data/album'
import * as groupData from './data/groupchat'
// import * as chatmoreData from './src/data/chatmore'
