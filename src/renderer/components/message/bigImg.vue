...
<div>
    <div id="demo">
        <div class="title">
            <span @click="winClose()" >×</span>
        </div>
        <div class="alice">
            <!-- 左侧按钮 -->
            <div id="leftBtn">
                    <span id="leftBtnSpan" class="icon iconfont icon-left-circle" @click="previous"></span>
            </div>
            <div class="imgBox">
                <img id="imgsrc" src="" alt="" @mousewheel="bigimg(this)" @mousedown="move(event)">
            </div>
            <!-- 右侧按钮 -->
            <div id="rightBtn">
                <span id="rightBtnSpan" class="icon iconfont icon-right-circle" @click="next"></span>
            </div>
        </div>
        <!-- 张数 -->
        ...
        <!-- 底部按钮 -->
        <div class="bottomBtn">
            <span class="large icon iconfont icon-plus-circle" @click="large(true)"></span>
            <span class="small icon iconfont icon-minus-circle" @click="large(false)"></span>
            <span class="leftDo icon iconfont icon-undo" @click="rotate(true)"></span>
            <span class="rightDo icon iconfont icon-redo" @click="rotate(false)"></span>
            <span class="icon iconfont icon-sync" @click="sync()"></span>
