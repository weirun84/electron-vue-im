<template>
    <div class="x-audio-wrap" :class="{inline:!block}" ref="wrap" :style="this.lengthStyleObj" @click="play">
    ...
    methods:{
        ...
        format(s){
            ...
            if(s > -1){
                ...
                var lengthWidth = s * 25;
                if (lengthWidth < 100) {
                    lengthWidth = 100;
                }
                this.lengthStyleObj = { width: lengthWidth+ "px" };
            }
            t=t.replace('.','\"')
            return t;
        },
